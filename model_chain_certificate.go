...
// checks if the ChainCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChainCertificate{}

// ChainCertificate A chain certificate.
...
func (o ChainCertificate) MarshalJSON() ([]byte, error) {
...
func (o ChainCertificate) ToMap() (map[string]interface{}, error) {
...
type NullableChainCertificate struct {
	value *ChainCertificate
	isSet bool
}

func (v NullableChainCertificate) Get() *ChainCertificate {
	return v.value
}

func (v *NullableChainCertificate) Set(val *ChainCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableChainCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableChainCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChainCertificate(val *ChainCertificate) *NullableChainCertificate {
	return &NullableChainCertificate{value: val, isSet: true}
}

func (v NullableChainCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChainCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
