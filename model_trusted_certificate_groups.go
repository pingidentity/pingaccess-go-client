...
// checks if the TrustedCertificateGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustedCertificateGroups{}
...
func (o TrustedCertificateGroups) ToMap() (map[string]interface{}, error) {
