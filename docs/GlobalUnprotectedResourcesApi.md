...
func main() {
    ...
    numberPerPage := int64(56) // int64 | Number of Global Unprotected Resources per page (optional)
 ...
 **numberPerPage** | **int64** | Number of Global Unprotected Resources per page | 
