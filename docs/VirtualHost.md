...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **int64** | When creating a new VirtualHost, this is the ID for the VirtualHost. If not specified, an ID will be automatically assigned. When updating an existing VirtualHost, this field is ignored and the ID is determined by the path parameter. | [optional] 
**Host** | **string** | (sortable) The host name for the Virtual Host. | 
**Port** | **int64** | (sortable) The integer port number for the Virtual Host. | 
**AgentResourceCacheTTL** | Pointer to **int64** | (sortable) Indicates the number of seconds the Agent can cache resources for this application. | [optional] 
**KeyPairId** | Pointer to **int64** | Key pair assigned to Virtual Host used by SNI, If no key pair is assigned to a virtual host, ENGINE HTTPS Listener key pair will be used. | [optional] 
**TrustedCertificateGroupId** | Pointer to **int64** | Trusted Certificate Group assigned to Virtual Host for client certificate authentication. | [optional] 
