...
`func NewEngineCertificate(serialNumber string, alias string, subjectDn string, issuerDn string, signatureAlgorithm string, status CertStatus, sha1sum string, md5sum string, sha256sum string, keyPair bool, chainCertificate bool, trustedCertificate bool, ) *EngineCertificate`
