...
// checks if the Descriptors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Descriptors{}
...
func (o Descriptors) ToMap() (map[string]interface{}, error) {
