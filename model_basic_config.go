...
// checks if the BasicConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BasicConfig{}
...
func (o BasicConfig) ToMap() (map[string]interface{}, error) {
