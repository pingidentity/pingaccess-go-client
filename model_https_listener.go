...
// checks if the HttpsListener type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpsListener{}
...
func (o HttpsListener) ToMap() (map[string]interface{}, error) {
