...
// checks if the RuleSets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleSets{}
...
func (o RuleSets) ToMap() (map[string]interface{}, error) {
