...
// checks if the PingFederateRuntime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PingFederateRuntime{}
...
func (o PingFederateRuntime) ToMap() (map[string]interface{}, error) {
