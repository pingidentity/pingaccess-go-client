...
// checks if the EngineListeners type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EngineListeners{}
...
func (o EngineListeners) ToMap() (map[string]interface{}, error) {
