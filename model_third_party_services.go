...
// checks if the ThirdPartyServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThirdPartyServices{}
...
func (o ThirdPartyServices) ToMap() (map[string]interface{}, error) {
