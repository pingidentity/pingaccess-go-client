...
// checks if the TrustedCerts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustedCerts{}
...
func (o TrustedCerts) ToMap() (map[string]interface{}, error) {
