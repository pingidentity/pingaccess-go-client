...
// EntryType the model 'EntryType'
type EntryType string

// List of EntryType
const (
	ENTRYTYPE_APPLICATION_RESOURCE EntryType = "ApplicationResource"
	ENTRYTYPE_GLOBAL_UNPROTECTED_RESOURCE EntryType = "GlobalUnprotectedResource"
)
