...
// checks if the WebSessionManagement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebSessionManagement{}
...
func (o WebSessionManagement) ToMap() (map[string]interface{}, error) {
