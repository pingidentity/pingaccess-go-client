...
// checks if the PKCS12FileImportDoc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PKCS12FileImportDoc{}
...
func (o PKCS12FileImportDoc) ToMap() (map[string]interface{}, error) {
