...
// checks if the AgentCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentCertificate{}
...
func (o AgentCertificate) ToMap() (map[string]interface{}, error) {
