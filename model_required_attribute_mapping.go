...
// checks if the RequiredAttributeMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequiredAttributeMapping{}
...
func (o RequiredAttributeMapping) ToMap() (map[string]interface{}, error) {
