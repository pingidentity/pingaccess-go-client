...
// checks if the QueryParamValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryParamValue{}
...
func (o QueryParamValue) ToMap() (map[string]interface{}, error) {
